...
load("Resultados_Mezcla_n60_phi0.RData")
Resultados_Mezcla_n60_phi0<-Resultados
load("Resultados_Mezcla_n60_phi03.RData")
Resultados_Mezcla_n60_phi03<-Resultados
load("Resultados_Mezcla_n60_phi05.RData")
Resultados_Mezcla_n60_phi05<-Resultados
load("Resultados_Mezcla_n60_phi07.RData")
Resultados_Mezcla_n60_phi07<-Resultados
load("Resultados_Mezcla_n60_phi08.RData")
Resultados_Mezcla_n60_phi08<-Resultados
load("Resultados_Mezcla_n60_phi09.RData")
Resultados_Mezcla_n60_phi09<-Resultados
...
GAM <- Resultados_Mezcla_n60_phi0$GAM
...
PR_M_n60_phi0 <-
  Resultados_Mezcla_n60_phi0$MISE /
  min(Resultados_Mezcla_n60_phi0$MISE)

PR_M_n60_phi03 <-
  Resultados_Mezcla_n60_phi03$MISE /
  min(Resultados_Mezcla_n60_phi03$MISE)

PR_M_n60_phi05 <-
  Resultados_Mezcla_n60_phi05$MISE /
  min(Resultados_Mezcla_n60_phi05$MISE)

PR_M_n60_phi07 <-
  Resultados_Mezcla_n60_phi07$MISE /
  min(Resultados_Mezcla_n60_phi07$MISE)

PR_M_n60_phi08 <-
  Resultados_Mezcla_n60_phi08$MISE /
  min(Resultados_Mezcla_n60_phi08$MISE)

PR_M_n60_phi09 <-
  Resultados_Mezcla_n60_phi09$MISE /
  min(Resultados_Mezcla_n60_phi09$MISE)
...
Resultados_PRP_Mezcla_n60 <- list(
  GAM = GAM,
  # PR_M_n60_phi0 = PR_M_n60_phi0,
...
save(
  Resultados_PRP_Mezcla_n60,
  file = "Resultados_PRP_Mezcla_n60.RData"
)
# rm(list = ls())
# 
# setwd("~/Desktop/tesis_sebastian/adaptive-density-weak-dep/scripts/calibration_study/Mezcla")
...
#   lwd  = 2,             # Grosor de línea
#   xlim = c(0, max_phi + 0.05),    # ZOOM EJE X: Cortamos en 0.15 para ver la separación de los mínimos
#   ylim = c(0.9, 4.5),   # ZOOM EJE Y: Enfocado en la base donde ocurren las caídas
#   xlab = expression(gamma),
#   ylab = "Pérdida Relativa (PR)",
#   main = "",            # APA 7: El título va en el documento de texto, no dentro del gráfico
#   bty  = "l"            # APA 7: Ejes en forma de "L", sin recuadro superior ni derecho
...
#   col  = "black",
#   xlim = c(0, 0.5),    # ZOOM EJE X: Para ver el comportamiento real del valle
#   ylim = c(1, 4),     # ZOOM EJE Y: Recortamos los valores extremos para enfocarnos en el mínimo
#   xlab = expression(gamma),
#   ylab = "Pérdida Relativa Promedio (PRP)",
#   main = "",            # APA 7 exige que el título vaya en el caption del documento, no en la imagen
#   bty  = "l"            # APA 7: Ejes en L, sin caja superior ni derecha
