...
load("Resultados_Lognormal_n120_phi0.RData")
Resultados_Lognormal_n120_phi0<-Resultados
load("Resultados_Lognormal_n120_phi03.RData")
Resultados_Lognormal_n120_phi03<-Resultados
load("Resultados_Lognormal_n120_phi05.RData")
Resultados_Lognormal_n120_phi05<-Resultados
load("Resultados_Lognormal_n120_phi07.RData")
Resultados_Lognormal_n120_phi07<-Resultados
load("Resultados_Lognormal_n120_phi08.RData")
Resultados_Lognormal_n120_phi08<-Resultados
load("Resultados_Lognormal_n120_phi09.RData")
Resultados_Lognormal_n120_phi09<-Resultados
...
GAM <- Resultados_Lognormal_n120_phi0$GAM
...
PR_M_n120_phi0 <-
  Resultados_Lognormal_n120_phi0$MISE /
  min(Resultados_Lognormal_n120_phi0$MISE)

PR_M_n120_phi03 <-
  Resultados_Lognormal_n120_phi03$MISE /
  min(Resultados_Lognormal_n120_phi03$MISE)

PR_M_n120_phi05 <-
  Resultados_Lognormal_n120_phi05$MISE /
  min(Resultados_Lognormal_n120_phi05$MISE)

PR_M_n120_phi07 <-
  Resultados_Lognormal_n120_phi07$MISE /
  min(Resultados_Lognormal_n120_phi07$MISE)

PR_M_n120_phi08 <-
  Resultados_Lognormal_n120_phi08$MISE /
  min(Resultados_Lognormal_n120_phi08$MISE)

PR_M_n120_phi09 <-
  Resultados_Lognormal_n120_phi09$MISE /
  min(Resultados_Lognormal_n120_phi09$MISE)
...
Tabla_PRP <- data.frame(
  GAM      = GAM,
  PR_M_n120_phi0  = PR_M_n120_phi0,
  PR_M_n120_phi0  = PR_M_n120_phi03,
  PR_M_n120_phi05 = PR_M_n120_phi05,
  PR_M_n120_phi07 = PR_M_n120_phi07,
  PR_M_n120_phi08 = PR_M_n120_phi08,
  PR_M_n120_phi09 = PR_M_n120_phi09,
  PRP      = PRP
)
...
# ind.phi0  <- which.min(PR_M_n120_phi0)
ind.phi03  <- which.min(PR_M_n120_phi03)
ind.phi05 <- which.min(PR_M_n120_phi05)
# ind.phi07 <- which.min(PR_M_n120_phi07)
# ind.phi08 <- which.min(PR_M_n120_phi08)
# ind.phi085 <- which.min(PR_M_n120_phi085)
ind.phi09 <- which.min(PR_M_n120_phi09)
...
# min.phi0  <- min(PR_M_n120_phi0)
min.phi03  <- min(PR_M_n120_phi03)
min.phi05 <- min(PR_M_n120_phi05)
# min.phi07 <- min(PR_M_n120_phi07)
# min.phi08 <- min(PR_M_n120_phi08)
# min.phi085 <- min(PR_M_n120_phi085)
min.phi09 <- min(PR_M_n120_phi09)
...
Resultados_PRP_Lognormal_n120 <- list(
  GAM = GAM,
  # PR_M_n120_phi0 = PR_M_n120_phi0,
  PR_M_n120_phi03 = PR_M_n120_phi03,
  PR_M_n120_phi05 = PR_M_n120_phi05,
  # PR_M_n120_phi07 = PR_M_n120_phi07,
  # PR_M_n120_phi08 = PR_M_n120_phi08,
  # PR_M_n120_phi085 = PR_M_n120_phi085,
  PR_M_n120_phi09 = PR_M_n120_phi09,
  PRP = PRP,
  gamma.opt = gamma.opt,
  PRP.min = PRP.min,
...
save(
  Resultados_PRP_Lognormal_n120,
  file = "Resultados_PRP_Lognormal_n120.RData"
)
...
# Tabla_PRP <- data.frame(
#   GAM      = GAM,
#   PR_LN_n120_phi0  = PR_LN_n120_phi0,
#   PR_LN_n120_phi05 = PR_LN_n120_phi05,
#   PR_LN_n120_phi07 = PR_LN_n120_phi07,
#   PR_LN_n120_phi08 = PR_LN_n120_phi08,
#   PR_LN_n120_phi09 = PR_LN_n120_phi09,
#   PRP      = PRP
# )
# 
# print(Tabla_PRP)
...
# #################################################
# 
# ind.phi0  <- which.min(PR_LN_n120_phi0)
# ind.phi05 <- which.min(PR_LN_n120_phi05)
# ind.phi07 <- which.min(PR_LN_n120_phi07)
# ind.phi08 <- which.min(PR_LN_n120_phi08)
# ind.phi09 <- which.min(PR_LN_n120_phi09)
# 
# gam.phi0  <- GAM[ind.phi0]
# gam.phi05 <- GAM[ind.phi05]
# gam.phi07 <- GAM[ind.phi07]
...
# gam.phi09 <- GAM[ind.phi09]
# 
# min.phi0  <- min(PR_LN_n120_phi0)
# min.phi05 <- min(PR_LN_n120_phi05)
# min.phi07 <- min(PR_LN_n120_phi07)
# min.phi08 <- min(PR_LN_n120_phi08)
# min.phi09 <- min(PR_LN_n120_phi09)
# 
