...
setwd("~/Desktop/tesis_sebastian/adaptive-density-weak-dep/scripts/calibration_study/Lognormal")

list.files(pattern = "RData")



load("Resultados_Lognormal_n250_phi0.RData")
Resultados_Lognormal_n250_phi0<-Resultados
load("Resultados_Lognormal_n250_phi03.RData")
Resultados_Lognormal_n250_phi03<-Resultados
load("Resultados_Lognormal_n250_phi05.RData")
Resultados_Lognormal_n250_phi05<-Resultados
load("Resultados_Lognormal_n250_phi07.RData")
Resultados_Lognormal_n250_phi07<-Resultados
load("Resultados_Lognormal_n250_phi08.RData")
Resultados_Lognormal_n250_phi08<-Resultados
load("Resultados_Lognormal_n250_phi09.RData")
Resultados_Lognormal_n250_phi09<-Resultados
...
GAM <- Resultados_Lognormal_n250_phi0$GAM
...
PR_M_n250_phi0 <-
  Resultados_Lognormal_n250_phi0$MISE /
  min(Resultados_Lognormal_n250_phi0$MISE)

PR_M_n250_phi03 <-
  Resultados_Lognormal_n250_phi03$MISE /
  min(Resultados_Lognormal_n250_phi03$MISE)

PR_M_n250_phi05 <-
  Resultados_Lognormal_n250_phi05$MISE /
  min(Resultados_Lognormal_n250_phi05$MISE)

PR_M_n250_phi07 <-
  Resultados_Lognormal_n250_phi07$MISE /
  min(Resultados_Lognormal_n250_phi07$MISE)

PR_M_n250_phi08 <-
  Resultados_Lognormal_n250_phi08$MISE /
  min(Resultados_Lognormal_n250_phi08$MISE)

PR_M_n250_phi09 <-
  Resultados_Lognormal_n250_phi09$MISE /
  min(Resultados_Lognormal_n250_phi09$MISE)
...
Tabla_PRP <- data.frame(
  GAM      = GAM,
  PR_M_n250_phi0  = PR_M_n250_phi0,
  PR_M_n250_phi0  = PR_M_n250_phi03,
  PR_M_n250_phi05 = PR_M_n250_phi05,
  PR_M_n250_phi07 = PR_M_n250_phi07,
  PR_M_n250_phi08 = PR_M_n250_phi08,
  PR_M_n250_phi09 = PR_M_n250_phi09,
  PRP      = PRP
)
...
# ind.phi0  <- which.min(PR_M_n250_phi0)
ind.phi03  <- which.min(PR_M_n250_phi03)
ind.phi05 <- which.min(PR_M_n250_phi05)
# ind.phi07 <- which.min(PR_M_n250_phi07)
# ind.phi08 <- which.min(PR_M_n250_phi08)
# ind.phi085 <- which.min(PR_M_n250_phi085)
ind.phi09 <- which.min(PR_M_n250_phi09)
...
# min.phi0  <- min(PR_M_n250_phi0)
min.phi03  <- min(PR_M_n250_phi03)
min.phi05 <- min(PR_M_n250_phi05)
# min.phi07 <- min(PR_M_n250_phi07)
# min.phi08 <- min(PR_M_n250_phi08)
# min.phi085 <- min(PR_M_n250_phi085)
min.phi09 <- min(PR_M_n250_phi09)
...
Resultados_PRP_Lognormal_n250 <- list(
  GAM = GAM,
  # PR_M_n250_phi0 = PR_M_n250_phi0,
  PR_M_n250_phi03 = PR_M_n250_phi03,
  PR_M_n250_phi05 = PR_M_n250_phi05,
  # PR_M_n250_phi07 = PR_M_n250_phi07,
  # PR_M_n250_phi08 = PR_M_n250_phi08,
  # PR_M_n250_phi085 = PR_M_n250_phi085,
  PR_M_n250_phi09 = PR_M_n250_phi09,
  PRP = PRP,
  gamma.opt = gamma.opt,
  PRP.min = PRP.min,
...
save(
  Resultados_PRP_Lognormal_n250,
  file = "Resultados_PRP_Lognormal_n250.RData"
)
# rm(list = ls())
# 
# setwd("~/Desktop/tesis_sebastian/adaptive-density-weak-dep/scripts/calibration_study/Lognormal")
...
# Tabla_PRP <- data.frame(
#   GAM      = GAM,
#   PR_LN_n250_phi0  = PR_LN_n250_phi0,
#   PR_LN_n250_phi05 = PR_LN_n250_phi05,
#   PR_LN_n250_phi07 = PR_LN_n250_phi07,
#   PR_LN_n250_phi08 = PR_LN_n250_phi08,
#   PR_LN_n250_phi09 = PR_LN_n250_phi09,
#   PRP      = PRP
# )
# 
# print(Tabla_PRP)
...
# #################################################
# 
# ind.phi0  <- which.min(PR_LN_n250_phi0)
# ind.phi05 <- which.min(PR_LN_n250_phi05)
# ind.phi07 <- which.min(PR_LN_n250_phi07)
# ind.phi08 <- which.min(PR_LN_n250_phi08)
# ind.phi09 <- which.min(PR_LN_n250_phi09)
# 
# gam.phi0  <- GAM[ind.phi0]
# gam.phi05 <- GAM[ind.phi05]
# gam.phi07 <- GAM[ind.phi07]
...
# gam.phi09 <- GAM[ind.phi09]
# 
# min.phi0  <- min(PR_LN_n250_phi0)
# min.phi05 <- min(PR_LN_n250_phi05)
# min.phi07 <- min(PR_LN_n250_phi07)
# min.phi08 <- min(PR_LN_n250_phi08)
# min.phi09 <- min(PR_LN_n250_phi09)
# 
# max_phi <- max(gam.phi0, gam.phi05, gam.phi07, gam.phi08, gam.phi09)
# 
# 
# # 1. Matplot con Zoom y formato limpio
# matplot(
...
#   ),
#   type = "l",           # Solo líneas ("l") para eliminar el ruido de los puntos solapados
#   lty  = 1:5,           # Tipos de línea distintos (sólida, punteada, guiones...)
#   col  = 1:5,           # Colores distintos
#   lwd  = 2,             # Grosor de línea
#   xlim = c(0, max_phi + 0.05),    # ZOOM EJE X: Cortamos en 0.15 para ver la separación de los mínimos
#   ylim = c(0.9, 2.5),   # ZOOM EJE Y: Enfocado en la base donde ocurren las caídas
#   xlab = expression(gamma),
...
# abline(h = min.phi07, col = 3, lty = 3, lwd = 1)
# abline(h = min.phi08, col = 4, lty = 3, lwd = 1)
# abline(h = min.phi09, col = 5, lty = 3, lwd = 1)
# 
# abline(v = gam.phi0,  col = 1, lty = 3, lwd = 1)
# abline(v = gam.phi05, col = 2, lty = 3, lwd = 1)
# abline(v = gam.phi07, col = 3, lty = 3, lwd = 1)
# abline(v = gam.phi08, col = 4, lty = 3, lwd = 1)
# abline(v = gam.phi09, col = 5, lty = 3, lwd = 1)
# 
# # 4. Puntos marcando exclusivamente los mínimos
# points(gam.phi0,  min.phi0,  pch = 19, col = 1, cex = 1.5)
# points(gam.phi05, min.phi05, pch = 19, col = 2, cex = 1.5)
# points(gam.phi07, min.phi07, pch = 19, col = 3, cex = 1.5)
# points(gam.phi08, min.phi08, pch = 19, col = 4, cex = 1.5) 
# points(gam.phi09, min.phi09, pch = 19, col = 5, cex = 1.5)
# 
# 
# 
# #################################################
...
#   lwd  = 2,             # Línea más gruesa para mejor visualización
#   col  = "black",
#   xlim = c(0, 0.15),    # ZOOM EJE X: Para ver el comportamiento real del valle
#   ylim = c(1, 2.5),     # ZOOM EJE Y: Recortamos los valores extremos para enfocarnos en el mínimo
#   xlab = expression(gamma),
#   ylab = "Pérdida Relativa Promedio (PRP)",
#   main = "",            # APA 7 exige que el título vaya en el caption del documento, no en la imagen
