...
load("Resultados_Normal_n250_phi0.RData")
Resultados_Normal_n250_phi0<-Resultados
load("Resultados_Normal_n250_phi03.RData")
Resultados_Normal_n250_phi03<-Resultados
load("Resultados_Normal_n250_phi05.RData")
Resultados_Normal_n250_phi05<-Resultados
load("Resultados_Normal_n250_phi07.RData")
Resultados_Normal_n250_phi07<-Resultados
load("Resultados_Normal_n250_phi08.RData")
Resultados_Normal_n250_phi08<-Resultados
load("Resultados_Normal_n250_phi085.RData")
Resultados_Normal_n250_phi085<-Resultados
load("Resultados_Normal_n250_phi09.RData")
Resultados_Normal_n250_phi09<-Resultados
...
GAM <- Resultados_Normal_n250_phi0$GAM
...
PR_M_n250_phi0 <-
  Resultados_Normal_n250_phi0$MISE /
  min(Resultados_Normal_n250_phi0$MISE)

PR_M_n250_phi03 <-
  Resultados_Normal_n250_phi03$MISE /
  min(Resultados_Normal_n250_phi03$MISE)

PR_M_n250_phi05 <-
  Resultados_Normal_n250_phi05$MISE /
  min(Resultados_Normal_n250_phi05$MISE)

PR_M_n250_phi07 <-
  Resultados_Normal_n250_phi07$MISE /
  min(Resultados_Normal_n250_phi07$MISE)

PR_M_n250_phi08 <-
  Resultados_Normal_n250_phi08$MISE /
  min(Resultados_Normal_n250_phi08$MISE)

PR_M_n250_phi085 <-
  Resultados_Normal_n250_phi085$MISE /
  min(Resultados_Normal_n250_phi085$MISE)

PR_M_n250_phi09 <-
  Resultados_Normal_n250_phi09$MISE /
  min(Resultados_Normal_n250_phi09$MISE)
...
Resultados_PRP_Normal_n250 <- list(
  GAM = GAM,
  # PR_M_n250_phi0 = PR_M_n250_phi0,
...
save(
  Resultados_PRP_Normal_n250,
  file = "Resultados_PRP_Normal_n250.RData"
)
...
#   ),
#   col = 1:6,
#   lty = 1:6,            # Coincide con los tipos de línea del matplot
#   lwd = 2,
#   cex = 0.9,
#   bty = "n"             # Sin caja alrededor de la leyenda
# )
...
# abline(h = min.phi08, col = 4, lty = 3, lwd = 1)
# abline(h = min.phi085, col = 5, lty = 3, lwd = 1)
# abline(h = min.phi09, col = 6, lty = 3, lwd = 1)
# 
# abline(v = gam.phi0,  col = 1, lty = 3, lwd = 1)
# abline(v = gam.phi05, col = 2, lty = 3, lwd = 1)
# abline(v = gam.phi07, col = 3, lty = 3, lwd = 1)
# abline(v = gam.phi08, col = 4, lty = 3, lwd = 1)
# abline(v = gam.phi085, col = 5, lty = 3, lwd = 1)
# abline(v = gam.phi09, col = 6, lty = 3, lwd = 1)
# 
# # 4. Puntos marcando exclusivamente los mínimos
# points(gam.phi0,  min.phi0,  pch = 19, col = 1, cex = 1.5)
# points(gam.phi05, min.phi05, pch = 19, col = 2, cex = 1.5)
...
# points(gam.phi08, min.phi08, pch = 19, col = 4, cex = 1.5)
# points(gam.phi085, min.phi085, pch = 19, col = 5, cex = 1.5) 
# points(gam.phi09, min.phi09, pch = 19, col = 6, cex = 1.5)
# 
# 
# #################################################
# # Grafico de la PRP
