...
load("Resultados_Normal_n120_phi0.RData")
Resultados_Normal_n120_phi0<-Resultados
load("Resultados_Normal_n120_phi03.RData")
Resultados_Normal_n120_phi03<-Resultados
load("Resultados_Normal_n120_phi05.RData")
Resultados_Normal_n120_phi05<-Resultados
load("Resultados_Normal_n120_phi07.RData")
Resultados_Normal_n120_phi07<-Resultados
load("Resultados_Normal_n120_phi08.RData")
Resultados_Normal_n120_phi08<-Resultados
load("Resultados_Normal_n120_phi085.RData")
Resultados_Normal_n120_phi085<-Resultados
load("Resultados_Normal_n120_phi09.RData")
Resultados_Normal_n120_phi09<-Resultados
...
GAM <- Resultados_Normal_n120_phi0$GAM
...
PR_M_n120_phi0 <-
  Resultados_Normal_n120_phi0$MISE /
  min(Resultados_Normal_n120_phi0$MISE)

PR_M_n120_phi03 <-
  Resultados_Normal_n120_phi03$MISE /
  min(Resultados_Normal_n120_phi03$MISE)

PR_M_n120_phi05 <-
  Resultados_Normal_n120_phi05$MISE /
  min(Resultados_Normal_n120_phi05$MISE)

PR_M_n120_phi07 <-
  Resultados_Normal_n120_phi07$MISE /
  min(Resultados_Normal_n120_phi07$MISE)

PR_M_n120_phi08 <-
  Resultados_Normal_n120_phi08$MISE /
  min(Resultados_Normal_n120_phi08$MISE)

PR_M_n120_phi085 <-
  Resultados_Normal_n120_phi085$MISE /
  min(Resultados_Normal_n120_phi085$MISE)

PR_M_n120_phi09 <-
  Resultados_Normal_n120_phi09$MISE /
  min(Resultados_Normal_n120_phi09$MISE)
...
Resultados_PRP_Normal_n120 <- list(
  GAM = GAM,
  # PR_M_n120_phi0 = PR_M_n120_phi0,
...
save(
  Resultados_PRP_Normal_n120,
  file = "Resultados_PRP_Normal_n120.RData"
)
# rm(list = ls())
# 
# setwd("~/Desktop/tesis_sebastian/adaptive-density-weak-dep/scripts/calibration_study/Normal")
