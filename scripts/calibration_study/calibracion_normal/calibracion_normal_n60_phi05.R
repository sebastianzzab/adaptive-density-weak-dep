...
GAM_phi05 <- c(
  seq(0.15, 0.22, by = 0.01),     # Acercamiento rápido hacia el valle
  seq(0.225, 0.320, by = 0.005),  # Zona de alta resolución alrededor del óptimo (0.26875)
  seq(0.33, 0.45, by = 0.02)      # Margen de seguridad para confirmar que la curva sube
)
