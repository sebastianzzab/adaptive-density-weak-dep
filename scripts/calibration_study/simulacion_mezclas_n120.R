###############################################################################
# Script: Estudio de simulación: Caso Mezcla Bimodal y Garra con n=120
...
load("Resultados_PRP_Mezcla_n120.RData")
...
obtener_gamma <- function(phi) {
  ...
  if(phi_str == "0")    return(Resultados_PRP_Mezcla_n120$gam.phi0)
  if(phi_str == "0.5")  return(Resultados_PRP_Mezcla_n120$gam.phi05)
  if(phi_str == "0.9")  return(Resultados_PRP_Mezcla_n120$gam.phi09)
...
ruta_muestras <- "muestras_generadas_mezclas_n120.RData"
...
# =====================================================================
ruta_anova <- "matrices_ise_anova_mezclas_n120.RData"
