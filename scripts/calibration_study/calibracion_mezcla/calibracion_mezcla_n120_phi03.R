...
if(n == 60 & phi==0) {
  ...
  nombre_imagen <- "Resultados_Mezcla_n60_phi03.png"
  ...
  nombre_imagen <- "Resultados_Mezcla_n120_phi03.png"
  ...
  nombre_imagen <- "Resultados_Mezcla_n250_phi03.png"
...
if(n == 60 & phi==0) {
  ...
  save(Resultados,file = "Resultados_Mezcla_n60_phi03.RData")
} else if(n == 60 & phi==0.5) {
  ...
  save(Resultados,file = "Resultados_Mezcla_n120_phi03.RData")
} else if(n == 120 & phi==0.5) {
  ...
  save(Resultados,file = "Resultados_Mezcla_n250_phi03.RData")
} else if(n == 250 & phi==0.5) {
