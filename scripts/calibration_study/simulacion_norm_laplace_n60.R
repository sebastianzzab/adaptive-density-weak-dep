###############################################################################
# Script: Estudio de simulación: Caso Normal y Laplace con n=60
...
# Generador para Normal Truncada (Transformada Inversa)
...
load("Resultados_PRP_Normal_n60.RData")
...
obtener_gamma <- function(phi) {
  ...
  if(phi_str == "0")    return(Resultados_PRP_Normal_n60$gam.phi0)
  if(phi_str == "0.5")  return(Resultados_PRP_Normal_n60$gam.phi05)
  if(phi_str == "0.9")  return(Resultados_PRP_Normal_n60$gam.phi09)
...
ruta_xlsx <- "mise_simulacion_norm_laplace_n60.xlsx"
write_xlsx(df_final_mise, path = ruta_xlsx)
cat("Archivo XLSX guardado en:", file.path(getwd(), ruta_xlsx), "\n")

ruta_xlsx2 <- "mse_simulacion_norm_laplace_n60.xlsx"
...
ruta_muestras <- "muestras_generadas_norm_laplace_n60.RData"
...
# =====================================================================
ruta_anova <- "matrices_ise_anova_norm_laplace_n60.RData"
