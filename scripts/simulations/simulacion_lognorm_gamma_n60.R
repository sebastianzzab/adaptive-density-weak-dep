###############################################################################
# Script: Estudio de simulación: Caso Lognormal y Gamma con n=60
...
load("Resultados_PRP_Lognormal_n60.RData")
...
obtener_gamma <- function(phi) {
  ...
  if(phi_str == "0")    return(Resultados_PRP_Lognormal_n60$gam.phi0)
  if(phi_str == "0.5")  return(Resultados_PRP_Lognormal_n60$gam.phi05)
  if(phi_str == "0.9")  return(Resultados_PRP_Lognormal_n60$gam.phi09)
...
ruta_xlsx2 <- "mse_simulacion_lognorm_gamma_n60.xlsx"
...
ruta_muestras <- "muestras_generadas_lognorm_gamma_n60.RData"
...
# =====================================================================
ruta_anova <- "matrices_ise_anova_lognorm_gamma_n60.RData"
