...
# =====================================================================
# 1. CONFIGURACIÓN GLOBAL Y SEMILLAS (GRUPO 2)
# =====================================================================
# CONFIG_n <- 60
# CONFIG_semilla_maestra <- 2060 # Semillas en la serie 2000 para independizar grupos

# CONFIG_n <- 120
# CONFIG_semilla_maestra <- 2120

CONFIG_n <- 250
CONFIG_semilla_maestra <- 2250

CONFIG_B <- 1000
CONFIG_niveles_phi <- c(0.3, 0.5, 0.9)
CONFIG_distribuciones <- c("normal", "laplace")
CONFIG_ruta_salida <- "./resultados_simulacion/Grupo2_Simetricas"
...
tabla_gammas <- data.frame(
  ...
  gamma_optimo = c(
    0.0825,	0.26875,	0.475, # Valores para Normal/Laplace n=60
    0.06,	0.065,	0.45625, # Valores para Normal/Laplace n=120
    0.055,	0.0775,	0.1625  # Valores para Normal/Laplace n=250
  )
)
